...
model = joblib.load(r"C:\Users\NEO\Desktop\Salary Prediction\random_forest_model (2).pkl")
scaler = joblib.load(r"C:\Users\NEO\Desktop\salary Prediction\scaler (1).pkl")
